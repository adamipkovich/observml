...
class FPGrowth(BaseEstimator):
    _model = None
    _figs : dict[str, pd.DataFrame] = {}

    def __init__(self, *, minsup ="10%", min_conf = "10%", min_len = 2, max_len = 3):
        ...
        self.model_name = "FPGrowth_association_rules"

    def fit(self, X: pd.DataFrame , y = None):
        
        self._model = SPMFCore(mode=self.model_name, minsup = self.minsup, minconf=self.min_conf, minlen=self.min_len, maxlen=self.max_len)
...
if __name__ == "__main__":
    ...
    print("DOES NOT WORK !!!! MEMORY HEAP PROBLEMS!") 
