...
def main():
    ...
    # Train experiment
    print(f"\nTraining experiment '{experiment_name}' of type '{experiment_type}'...")
    try:
        result = hub.create_experiment(experiment_name, experiment_type, config)
    ...
    try:
        predictions = hub.predict(experiment_name)
